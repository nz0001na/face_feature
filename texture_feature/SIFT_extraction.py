...
dbs = os.listdir(ro)
for db in dbs:
    # if db != '4_FERET_stylegan' : continue
    # or db == '3_FERET_opencv' or db == '2_FERET_facemorpher'
    db_path = ro + db + '/'
    ...
    if os.path.exists(dst_path + 'SIFT_train_test.mat') is True: continue
    print(db)
    # read train feature
    train_feature = []
    train_label = []
    ...
    dst_file = dst_path + 'SIFT_train_test.mat'
