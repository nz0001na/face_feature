'''
this code is to extract feature of EfficientNetB7 network
code is from: https://keras.io/examples/vision/image_classification_efficientnet_fine_tuning/
'''
...
for db in dbs:
    ...
    print(db)
    if os.path.exists(dst_path + nn_name + '_train_test.mat') is True: continue
    # read train feature
    train_feature = []
    train_label = []
